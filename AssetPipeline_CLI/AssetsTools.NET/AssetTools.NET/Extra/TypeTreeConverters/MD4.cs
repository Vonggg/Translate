...
{
    //https://github.com/novotnyllc/cifs/blob/master/Cifs/MD4.cs
    public class MD4
    {
        ...
        public void Update(byte[] bytes) => EngineUpdate(bytes, 0, bytes.Length);
        public byte[] Digest() => EngineDigest();
